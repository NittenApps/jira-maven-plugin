...
package dev.nittenapps.maven.plugins.issues;
...
public class IssuesReportGenerator extends AbstractIssuesReportGenerator {
    ...
    /**
     * Holds the names for the columns to include in the report, in the order that they should appear in the report.
     */
     ...
     * Constructor.
     *
     * @param includedColumns The name of the columns to include in the report
     */
    ...
    public void doGenerateReport(ResourceBundle bundle, Sink sink, List<Issue> issueList) {
        ...
        constructDetailRows(sink, issueList, new Locale("sv"));
    ...
    private void constructDetailRows(Sink sink, List<Issue> issueList, Locale locale) {
        if (issueList == null) {
            return;
        }
