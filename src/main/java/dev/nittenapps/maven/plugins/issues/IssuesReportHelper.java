...
public class IssuesReportHelper {
    ...
    public static List<Integer> getColumnIds(String columnNames, Map<String, Integer> allColumns,
        ...
        final DualHashBidiMap bidiColumns;
        ...
        Arrays.stream(columnNamesArray).map(String::trim)
                .forEach(columnName -> {
                    if (allColumns.containsKey(columnName)) {
                        ...
                        if (log != null) {
                            log.warn("The columnName '" + columnName + "' has been deprecated."
                                    + " Please use the columnName '" + bidiColumns.getKey(columnId) + "' instead.");
                        }
                    }
                });
        return columnIds;
